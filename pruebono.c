...
int maximo1 (struct TDistrito[], int dim);

int main () {
    	
	int estadisticas, media_particular, maximo, minimo;
	float media1, media2, media3, media4, maximo2, maximo3, maximo4, minimo1, minimo2, minimo3, minimo4;
	int contador1;
	...
	switch(estadisticas){ //hacer estadisticas 
		...
		case 2:
			...
			switch(maximo){
				...
				case 1:
					printf("Maximo de pH = %d", mes[contador1].ph);
					break;
				case 2:
...
*/
int maximo1 (struct TDistrito mes[], int dim){ //maximo ph
